...
# V6.5b: capitulation reversal — relaxed cascade + no liq_imb filter.
...
ENTRY_CASCADE_MAX = 999.0  # relaxed: no upper bound
...
class LiqClusterEngineV5:
    ...
    def evaluate(self, symbol: str, candles_5m: list[Candle]) -> Optional[Signal]:
        ...
        # Capitulation filter removed: liq_imb filter showed no edge in replay analysis
