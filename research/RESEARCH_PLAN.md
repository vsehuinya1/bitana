...
| NY 1h-profile hour re-optimization — **G0 registered Sep-6 post-scan (DISCLOSED: hours ranked post-hoc from full-window variant scan — fresh-window-only promotion)** | G0 | Basis (bull, raw variants, Aug16→Sep6): h14 +0.082/n97 · h15 +0.102/n15 · h16 +0.054/n47 · h17 −0.008/n44 · h18 +0.042/n53 · h19 −0.023/n27 · h20 −0.038/n44 (4h comparators in Sun-loop report; Wed-h18 4h tail −0.82/n3 → 1h −0.04/n4) | Live arm accrues per-hour cohorts under current lattice (bull h14-20 ex-Tue-map); h15 accrues shadow-only | First per-hour fresh read Sun Sep-13, formal Sep-20: re-open h15 or drop h19/h20 only on fresh per-hour E>+0.03 at n≥30 or ≥3d, top-day ≤40%; one-line config per hour | Kill: fresh per-hour E ≤ 0 on any re-opened cell; drops only if fresh confirms ≤ 0 |
