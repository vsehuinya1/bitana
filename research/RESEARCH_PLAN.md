...
| NY 1h-profile hour re-optimization — **G0 registered Sep-6 post-scan (DISCLOSED: hours ranked post-hoc from full-window variant scan — fresh-window-only promotion)** | G0 — **lattice RE-CUT EXECUTED Sep-6 (commit a1403d6): dropped Tue h16 0/6 · Wed h19 0/8 · Wed h20 −3.2R/n26 · Fri h17 0/9 fresh 0/7 (rule: WR=0% at n≥6, or E≤−0.10 at n≥20); re-open bar higher: fresh E>+0.10 at n≥10** | Basis (bull, raw variants, Aug16→Sep6): h14 +0.082/n97 · h15 +0.102/n15 · h16 +0.054/n47 · h17 −0.008/n44 · h18 +0.042/n53 · h19 −0.023/n27 · h20 −0.038/n44 (4h comparators in Sun-loop report; Wed-h18 4h tail −0.82/n3 → 1h −0.04/n4). Wired lattice now: Tue h14 · Wed h14/16/17 · Thu h14/16/17/19 · Fri h14/16/18/19/20 | Dropped cells keep accruing in shadow variants (audit input); h15 accrues shadow-only | Sep-13 read: audit the 4 cuts (dropped-cell shadow cohorts must NOT go fresh-positive, else re-open per bar) + h15 re-open decision at fresh E>+0.03 n≥30/≥3d top-day ≤40% | Kill: fresh per-hour E ≤ 0 on any re-opened cell; cuts confirmed if dropped cells stay ≤ 0 fresh |
| London arm stop tighten (`stop_atr` 10→6 flat, bull+bear legs) — **G0 wired Sep-7 (owner order, one line + live restart 14:03Z, checksum-verified)** | G0 — wired Sep-7 | Basis: per-bar in-hold MAE — registered 213-leg set worst excursion 5.1 ATR (0 stopouts ≥6, ladder flat 5-10 on the 30m arm AND the 60m deduced arm: 0 core-book stopouts in bars 7-12, SL4 −4.8/−16.5). Full-book disclosure: XRP Aug-28 h13 MAE −6.39 → TP+3.0 (SL6 would cost 9.0 ATR) vs ETH Sep-2 −5.50 → time −4.14 (SL6 saves 1.9) — net −7.1 ATR over 292 legs (~5% of arm edge), disclosed not blocking. 1R now = 6 ATR: notional ×1.67 at same risk, min-notional clears easier; cross-era comparisons in ATR units only. Shadow baseline STAYS SL10 for the paired read | Paired audit Sep-13 + Sep-20: SL6 live cohort (R = pnl/6-ATR stop) vs wide-stop shadow baseline, same entries | Kill: SL6 cohort E < wide baseline at n≥20 → revert one line |
