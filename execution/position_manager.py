...
from core.models import (
    Candle, Position, PositionState, Side, TradeRecord,
)
...
class PositionManager:
    ...
    def __init__(
        ...
        self._cfg = config
        self._db = database
        self._positions: dict[str, Position] = {}  # trade_uuid -> Position
    ...
    async def manage_on_candle_close(
        ...
        Returns list of TradeRecords for closed trades.
        """
        ...
        for pos in list(self._positions.values()):
            ...
            if not pos.tp1_hit and r_multiple >= cfg.partial_close_r:
                ...
                result = await self._orders.execute_exit(
                    pos, tp_qty, reason="partial_tp"
                )
